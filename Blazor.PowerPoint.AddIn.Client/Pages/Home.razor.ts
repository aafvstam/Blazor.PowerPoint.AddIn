...
export async function createSlide() {
    ...
    try {
        await PowerPoint.run(async function (context) {
            ...
            // Get the selected slide (the one we just navigated to) and load its shapes
            const newSlide = context.presentation.getSelectedSlides().getItemAt(0);
            ...
            textbox.name = "HelloWorld";

            // Align the text centered in the textbox
            textbox.textFrame.textRange.paragraphFormat.horizontalAlignment = PowerPoint.ParagraphHorizontalAlignment.center;

            textbox = shapes.addTextBox("This is a welcome slide with some nice graphics.",
                {
                    left: 255,
                    top: 110,
                    height: 50,
            ...
            textbox.name = "WelcomeMessage";

            // Align the text centered in the textbox
            textbox.textFrame.textRange.paragraphFormat.horizontalAlignment = PowerPoint.ParagraphHorizontalAlignment.center;

            // https://learn.microsoft.com/en-us/office/dev/add-ins/tutorials/powerpoint-tutorial-yo#insert-an-image
            ...
            await insertImage(base64Image);
            
            console.log("Welcome slide created successfully.");
        });
    } catch (error) {
